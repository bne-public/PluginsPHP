...
/**
 * InlineResponse2005Registros Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2005Registros implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_5_Registros';
    ...
    public function setNumDdd($num_ddd)
    {
        if (!is_null($num_ddd) && (strlen($num_ddd) > 2)) {
            throw new \InvalidArgumentException('invalid length for $num_ddd when calling InlineResponse2005Registros., must be smaller than or equal to 2.');
        }
        if (!is_null($num_ddd) && (strlen($num_ddd) < 2)) {
            throw new \InvalidArgumentException('invalid length for $num_ddd when calling InlineResponse2005Registros., must be bigger than or equal to 2.');
        }
    ...
    public function setTelefone($telefone)
    {
        if (!is_null($telefone) && (strlen($telefone) > 9)) {
            throw new \InvalidArgumentException('invalid length for $telefone when calling InlineResponse2005Registros., must be smaller than or equal to 9.');
        }
        if (!is_null($telefone) && (strlen($telefone) < 8)) {
            throw new \InvalidArgumentException('invalid length for $telefone when calling InlineResponse2005Registros., must be bigger than or equal to 8.');
        }
    ...
    public function setFuncao($funcao)
    {
        if ((strlen($funcao) > 200)) {
            throw new \InvalidArgumentException('invalid length for $funcao when calling InlineResponse2005Registros., must be smaller than or equal to 200.');
        }
        if ((strlen($funcao) < 4)) {
            throw new \InvalidArgumentException('invalid length for $funcao when calling InlineResponse2005Registros., must be bigger than or equal to 4.');
        }
    ...
    public function setCidade($cidade)
    {
        if ((strlen($cidade) > 200)) {
            throw new \InvalidArgumentException('invalid length for $cidade when calling InlineResponse2005Registros., must be smaller than or equal to 200.');
        }
        if ((strlen($cidade) < 5)) {
            throw new \InvalidArgumentException('invalid length for $cidade when calling InlineResponse2005Registros., must be bigger than or equal to 5.');
        }
